...
var docStyle = document.head.style || document.body.style;
...
var stylefill = {
  ...
  loadFile: function (url, count) {
	...
	checkRule : function (property) {
		...
		if (('Webkit' + propertyCamel) in docStyle
		 || ('Moz' + propertyCamel) in docStyle
		 || ('O' + propertyCamel) in docStyle
		 || property in docStyle) return true;
  ...
  checkRule: function (property) {
    ...
    if (
      ('Webkit' + propertyCamel) in docStyle
      || ('Moz' + propertyCamel) in docStyle
      || ('O' + propertyCamel) in docStyle
      || property in docStyle
    ) {
      return true;
    }
  },
